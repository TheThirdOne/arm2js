inst = {};
inst.mov = {additional:{s:'F'},parser:['rn','?op'],str:"$1 =  $2"};//move
inst.mvn = {additional:{s:'F'},parser:['rn','?op'],str:"$1 = ~$2"};//move not
...
inst.mul = {additional:{s:'F'},parser:['rn','rn','rn'],str:"$1 = $2 *  $3"};      //multiply
inst.mla = {additional:{s:'F'},parser:['rn','rn','rn','rn'],str:"$1 = $4 +  $2 * $3"};
...
inst.cmp = {parser:['rn','?op'],str:"$0 = $2 - $3; F"};
inst.cmn = {parser:['rn','?op'],str:"$0 = $2 + $3; F"};
inst.tst = {parser:['rn','?op'],str:"$0 = $2 & $3; F"};
inst.teq = {parser:['rn','?op'],str:"$0 = $2 ^ $3; F"};
